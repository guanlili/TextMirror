...
echo.
echo ============================================================
echo   TextMirror - Build Docker Images Locally
...
echo ============================================================
echo [3/4] Exporting backend image to docker-images\textmirror-backend.tar
echo       (~300-500MB, please wait...)
echo ============================================================
docker save -o docker-images\textmirror-backend.tar textmirror-backend:latest
if %errorlevel% neq 0 (
...
echo ============================================================
echo [4/4] Exporting frontend image to docker-images\textmirror-frontend.tar
echo       (~30-80MB, please wait...)
echo ============================================================
docker save -o docker-images\textmirror-frontend.tar textmirror-frontend:latest
if %errorlevel% neq 0 (
...
echo ============================================================
echo.
for %%F in (docker-images\textmirror-backend.tar) do (
    set "size=%%~zF"
    set /a "sizeMB=!size! / 1048576"
    echo   textmirror-backend.tar   !sizeMB! MB
)
for %%F in (docker-images\textmirror-frontend.tar) do (
    set "size=%%~zF"
    set /a "sizeMB=!size! / 1048576"
    echo   textmirror-frontend.tar  !sizeMB! MB
)
echo.
echo ============================================================
echo   NEXT STEPS:
echo ============================================================
echo.
echo   1. Upload these files to server /opt/TextMirror/:
echo.
echo      docker-images\textmirror-backend.tar
echo      docker-images\textmirror-frontend.tar
