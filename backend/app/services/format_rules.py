...
# 登陆/登录同理：「登陆海南岛」「部队登陆后」成立，但登陆+数字语境宾语
# （系统/账号等）只会是「登录」的误用；故只收名词宾语搭配，不收「登陆后」
# 「登陆成功」等可能与军事登陆语境相容的组合。
CONFUSABLE_COLLOCATIONS = [
    ...
    ("登陆系统", "登录系统", "进入系统/网站应为「登录」（登陆=到达陆地，如登陆海南岛）"),
    ("登陆账号", "登录账号", "进入账号应为「登录」（登陆=到达陆地）"),
    ("登陆网站", "登录网站", "进入网站应为「登录」（登陆=到达陆地）"),
    ("登陆平台", "登录平台", "进入平台应为「登录」（登陆=到达陆地）"),
    ("登陆后台", "登录后台", "进入后台应为「登录」（登陆=到达陆地）"),
    ("登陆界面", "登录界面", "进入界面应为「登录」（登陆=到达陆地）"),
]
