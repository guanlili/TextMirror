...
@router.get("/config", response_model=FeishuConfigResponse, summary='获取飞书扫码登录配置')
...
@router.post("/callback", response_model=FeishuCallbackResponse, summary='飞书授权回调')
...
@router.get("/sso", summary='飞书工作台SSO入口')
