...
@router.get("", response_model=list[DictionaryResponse], summary='获取当前用户的词库列表')
...
@router.post("", response_model=DictionaryResponse, status_code=201, summary='创建词库')
...
@router.put("/{dict_id}", response_model=DictionaryResponse, summary='更新词库')
...
@router.delete("/{dict_id}", status_code=204, summary='删除词库（级联删除词条）')
...
@router.post("/{dict_id}/entries/batch", status_code=201, summary='批量添加词条')
...
@router.delete("/{dict_id}/entries/{entry_id}", status_code=204, summary='删除词条')
